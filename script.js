...
{ id:104,name:"GTX 1080",price:5500,img:"images/gpu/gtx1080.png",cat:"gpu",specs:["8GB","GDDR5X"]},
{ id:105,name:"GTX 1660",price:6500,img:"images/gpu/gtx1660.png",cat:"gpu",specs:["6GB","GDDR5"]},

{ id:106,name:"RTX 3050",price:8000,img:"images/gpu/rtx3050.png",cat:"gpu",specs:["8GB","Ray Tracing"]},
{ id:107,name:"RTX 3060",price:15000,img:"images/gpu/rtx3060.png",cat:"gpu",specs:["12GB","Ray Tracing"]},
{ id:108,name:"RTX 3080",price:22000,img:"images/gpu/rtx3080.png",cat:"gpu",specs:["10GB","4K Gaming"]},
{ id:109,name:"RTX 4060",price:18000,img:"images/gpu/rtx4060.png",cat:"gpu",specs:["8GB","DLSS3"]},
{ id:110,name:"RTX 4070",price:25000,img:"images/gpu/rtx4070.png",cat:"gpu",specs:["12GB","DLSS3"]},
{ id:111,name:"RTX 4080",price:32000,img:"images/gpu/rtx4080.png",cat:"gpu",specs:["16GB","Ultra"]},
{ id:112,name:"RTX 4090",price:45000,img:"images/gpu/rtx4090.png",cat:"gpu",specs:["24GB","Extreme"]},

/* ================= RAM ================= */

{ id:200,name:"DDR4 8GB",price:1200,img:"images/ram/ddr4.png",cat:"ram",specs:["8GB","3200MHz"]},
{ id:201,name:"DDR4 16GB",price:2200,img:"images/ram/ddr4.png",cat:"ram",specs:["16GB","3200MHz"]},
{ id:202,name:"DDR5 16GB",price:3500,img:"images/ram/ddr5.png",cat:"ram",specs:["16GB","5600MHz"]},
{ id:203,name:"DDR5 32GB",price:6000,img:"images/ram/ddr5.png",cat:"ram",specs:["32GB","6000MHz"]},
...
{ id:221,name:"650W PSU",price:1700,img:"images/psu/psu2.png",cat:"psu",specs:["650W","80+ Bronze"]},
...
{ id:231,name:"Wireless Mouse",price:600,img:"images/accessories/mouse.png",cat:"accessories",specs:["Wireless","RGB"]},
...
function loadProduct(){
    ...
    let specsBox = document.getElementById("specs");
    if(specsBox){
        specsBox.innerHTML = "";
        p.specs.forEach(s=>{
            specsBox.innerHTML += `<li>${s}</li>`;
        });
    }
}
...
function showPrivacy(){
    ...
    <p>
    1. جمع المعلومات<br>
    يقوم متجر GRANDTECHNOLOGY بجمع المعلومات الضرورية فقط لإتمام عملية الشراء.<br><br>

    2. استخدام المعلومات<br>
    تُستخدم فقط لمعالجة الطلبات والتواصل مع العملاء.<br><br>

    3. حماية البيانات<br>
    لا نشارك بياناتك مع أي طرف ثالث دون موافقتك.<br><br>

    4. الأمان<br>
    نستخدم تقنيات حماية متقدمة.<br><br>

    5. حقوق العملاء<br>
    يمكنك طلب تعديل أو حذف بياناتك.<br><br>
